...
import TopTabNavigator from './PostSection'
        ...
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                <View style={styles.icons}>
                    ...
                    <Text style={{ fontSize: 15, fontWeight: '600' }}>{data?.user?.username}</Text>
                    {' '}{data?.user?.is_verified && (<Image source={CONSTANT_IMAGES?.verificationBadge} style={styles.verifyBadge} />)}
            ...
            <View style={styles.profileInfo}>
                <View style={styles.profilePic}>
                    ...
                    <Image source={{ uri: data?.owner?.profile_pic_url }} style={styles.profilePic} />
                </View>
